...
function fdl_contenu()
{
    ...
    '<img style="float: left; height: 80px; width: auto; margin-top: 20px; margin-left: 2rem; margin-right: 2rem;" src="images/eco-friendly.png" alt="Logo eco-friendly">',
    ...
    '<img style="float: right; height: 80px; width: auto; margin-top: 10px; margin-right: 2rem; margin-left: 2rem;" src="images/rgpd.png" alt="Logo RGPD">',
