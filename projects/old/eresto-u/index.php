...
fd_entete('Accueil', './styles/eResto.css');
// génération du menu (connecté ou pas)
fd_menu('Accueil', '.', isset($_SESSION['user']) ? $_SESSION['user']['login']: false);
...
function fdl_contenu() {
    echo 
        '<p>Finies les interminables files d\'attente qui s\'étiraient jusqu\'à l\'extérieur des bâtiments. ', 
        'Inspirées du système click-and-collect des grandes enseignes de la restauration rapide, les commandes du Resto-U sont désormais digitalisées pour un <strong>repas 2.0</strong> !</p>',
        ...
        '<section>', 
            ...
            '<div class="technos">', 
                '<img src="images/technos/html5.png" alt="Logo HTML5" id="logoHTML">',
                '<img src="images/technos/css3.png" alt="Logo CSS3" id="logoCSS">',
                '<img src="images/technos/javascript.png" alt="Logo Javascript" id="logoJS">',
                '<img src="images/technos/php.png" alt="Logo PHP" id="logoPHP">',
                '<img src="images/technos/mysql.png" alt="Logo MySQL" id="logoMySQL">',
                '<img src="images/technos/ajax.png" alt="Logo AJAX" id="logoAJAX">',
                '<img src="images/technos/pwa.png" alt="Logo Progressive Web App" id="logoPWA">',
            '</div>',
        '</section>',
        ...
        '<div class="liens">',
            '<a href="#fonctionnement">Le fonctionnement de eResto-U</a>',
            '<a href="#avantages">Les avantages de eResto-U</a>',
            '<a href="#partenariat">Un partenariat 100% Franc-Comtois</a>',
        '</div>',
        ...
        '<section id="fonctionnement">',
            ...
            '<ol>',
                ...
                '<li>Quand le plateau est prêt, le numéro de votre commande est appelé et il apparaît sur l\'écran récapitulant les commandes en attente de récupération. Si vous avez commandé avec l\'application mobile, une notification apparaîtra sur votre appareil. Votre carte multi-services vous permet de récuperer votre commande en toute autonomie.</li>',
                '<li>Vous retirez ensuite votre plateau, et regagnez votre place pour profiter de votre repas.</li>',
        ...
        '<section id="avantages">',
            ...
            '<ul>',
                ...
                '<li>Création d\'emplois étudiants supplémentaires pour la préparation des commandes <img src="images/point-interrogation.png" alt="icone point interrogation" id="pi"><span>(dans la limite d\'un budget en baisse constante)</span>.</li>',
            '</ul>',
        '</section>',
        ...
        '<section id="partenariat">',
            ...
            '<h4>Un puissant outil d\'aide à la décision</h4>',
            '<img style="float: left; height: 80px; width: auto; margin-top: 20px; margin-right: 10px;" src="images/eco-friendly.png" alt="Logo eco-friendly">',
            ...
            '<img style="float: right; height: 80px; width: auto; margin-top: 10px; margin-left: 10px;" src="images/rgpd.png" alt="Logo RGPD">',
