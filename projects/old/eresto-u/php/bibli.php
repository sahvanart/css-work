...
*
* @param objet  $bd     connecteur sur la bdd ouverte
...
function get_tableau_mois(){
    return array('Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août',
...
*/
function fd_controle_parametres($tab_global, $cles_obligatoires, 
 ...
 *
 * @param string	$t	tableau dont les infos sont à afficher
 */
